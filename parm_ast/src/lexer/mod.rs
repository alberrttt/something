...
impl<'src> Lexer<'src> {
    ...
    pub(crate) fn ident(&mut self) -> Token<'src> {
        ...
        match lexeme {
            "true" => TrueKw { lexeme, span }.into(),
            "false" => FalseKw { lexeme, span }.into(),
            "if" => IfKw { lexeme, span }.into(),
            "else" => ElseKw { lexeme, span }.into(),
            "fn" => FnKw { lexeme, span }.into(),
            "return" => ReturnKw { lexeme, span }.into(),
            "let" => LetKw { lexeme, span }.into(),
            "mut" => MutKw { lexeme, span }.into(),
            "use" => UseKw { lexeme, span }.into(),
            "loop" => LoopKw { lexeme, span }.into(),
            "while" => WhileKw { lexeme, span }.into(),
            "for" => ForKw { lexeme, span }.into(),
            "in" => InKw { lexeme, span }.into(),
            "break" => BreakKw { lexeme, span }.into(),
            "continue" => ContinueKw { lexeme, span }.into(),
            "struct" => StructKw { lexeme, span }.into(),
            "enum" => EnumKw { lexeme, span }.into(),
            "impl" => ImplKw { lexeme, span }.into(),
            "trait" => TraitKw { lexeme, span }.into(),
            "type" => TypeKw { lexeme, span }.into(),
