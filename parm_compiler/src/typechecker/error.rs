use crate::ast::error::{display_annotations, Annotation};
use crate::ast::prelude::*;

use super::{prelude::*, SourceFile};
use ast::*;
...
impl<'a> Display for TypeError<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut annotations: HashMap<Span, crate::ast::error::Annotation> = HashMap::new();
...
pub fn display_diagnostic<'a>(
    ...
    let mut annotations: HashMap<Span, Annotation> = HashMap::new();
